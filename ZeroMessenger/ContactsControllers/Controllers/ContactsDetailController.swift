...
class ContactsDetailController: UITableViewController {
  ...
  let invitationText = "Hey! Download Zero Messenger on the App Store. https://itunes.apple.com/ua/app/zero-messenger/id1313765714?mt=8 "
  ...
  override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
    ...
    if indexPath.section == 0 {
      ...
      cell.textLabel?.text = "Invite to Zero"
      cell.textLabel?.font = UIFont.systemFont(ofSize: 17)
    }
    return cell
  }
