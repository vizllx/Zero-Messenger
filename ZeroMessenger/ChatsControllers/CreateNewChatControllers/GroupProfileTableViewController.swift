...
class GroupProfileTableViewController: UITableViewController {
  ...
  fileprivate func setupTableView() {
    ...
    tableView.register(ZeroUsersTableViewCell.self, forCellReuseIdentifier: selectedFlaconUsersCellID)
  ...
  override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
    let cell = tableView.dequeueReusableCell(withIdentifier: selectedFlaconUsersCellID, for: indexPath) as? ZeroUsersTableViewCell ?? ZeroUsersTableViewCell()
