  ...
  func updateUserData() {
    ...
    userReference.updateChildValues(["name": userProfileContainerView.name.text!,
      ...
      self.dismiss(animated: true) {
        ...
        if let tabBarController = appDelegate.window!.rootViewController as? GeneralTabBarController {
            tabBarController.splashContainer.removeFromSuperview()
            tabBarController.selectedIndex = Tabs.contacts.rawValue
            
        }
//            tabBarController.chatsController.isAppLoaded = false
//            tabBarController.chatsController.viewDidLoad()
//            tabBarController.chatsController.viewWillAppear(false)
//            tabBarController.settingsController.viewDidLoad()
//            tabBarController.settingsController.viewWillAppear(false)
//
//        }
