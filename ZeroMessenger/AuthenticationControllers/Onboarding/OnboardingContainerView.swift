...
class OnboardingContainerView: UIView {
  ...
  let welcomeTitle: UILabel = {
    ...
    welcomeTitle.text = "Welcome to Zero Messenger"
  ...
  let startMessaging: UIButton = {
    ...
    startMessaging.setTitle("Start chatting", for: .normal)
    startMessaging.setTitleColor(ZeroPalette.defaultBlue, for: .normal)
