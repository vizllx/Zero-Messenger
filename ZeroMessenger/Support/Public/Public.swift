...
//  ZeroMessger
//
//  Created by Sandeep Mukherjee on 8/4/20.
...
let cameraAccessDeniedMessage = "Zero needs access to your camera to take photos and videos.\n\nPlease go to Settings –– Privacy –– Camera –– and set Zero to ON."
let contactsAccessDeniedMessage = "Zero needs access to your contacts to create new ones.\n\nPlease go to Settings –– Privacy –– Contacts –– and set Zero to ON."
let microphoneAccessDeniedMessage = "Zero needs access to your microphone to record audio messages.\n\nPlease go to Settings –– Privacy –– Microphone –– and set Zero to ON."
let photoLibraryAccessDeniedMessage = "Zero needs access to your photo library to send photos and videos.\n\nPlease go to Settings –– Privacy –– Photos –– and set Zero to ON."

let cameraAccessDeniedMessageProfilePicture = "Zero needs access to your camera to take photo for your profile.\n\nPlease go to Settings –– Privacy –– Camera –– and set Zero to ON."
let photoLibraryAccessDeniedMessageProfilePicture = "Zero needs access to your photo library to select photo for your profile.\n\nPlease go to Settings –– Privacy –– Photos –– and set Zero to ON."

let videoRecordedButLibraryUnavailableError = "To send a recorded video, it has to be saved to your photo library first. Please go to Settings –– Privacy –– Photos –– and set Zero to ON."
